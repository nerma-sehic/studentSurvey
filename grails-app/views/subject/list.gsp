...
<div class="container">
    ...
    <div class="row create_button_holder_no_submenu">
        <div class="col-md-2 col-xs-12 no-padding">
            <g:link controller="subject" action="create" class="btn btn-default create_button_link">Dodaj novi kolegij&nbsp;&nbsp;<i class="fa fa-plus addNew"></i></g:link>
        </div>
    </div>
...
<script>
    ...
    function loadSubjectTable(){
        jQuery.ajax({
            type: 'POST',
            dataType: 'html',
            url: "${g.createLink(controller: 'subject', action: 'ajaxLoadSubjectTable')}",
