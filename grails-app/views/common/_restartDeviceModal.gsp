                ...
                <div class="row">
                    <div class="col-xs-12 no-padding">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <a name="Cancel" id="cancelBtn" class="btn btn-default" style="width:100%;">Cancel</a>
                        </div>
                        <div class="col-xs-12 col-sm-12 hidden-md hidden-lg">&nbsp;</div>
                        <div class="col-md-6 col-sm-12">
                            <button type="submit" class="btn btn-purple" style="width:100%;">Restart</button>
                        </div>
                    </div>
                </div>
            </div>
