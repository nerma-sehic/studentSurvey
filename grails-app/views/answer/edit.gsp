...
<div class="container">
    ...
    <g:form method="post" class="form-horizontal" style="border-top: 0;">
        <div class="contentHolder no-menu-margin"  style="border-top: 0;">
            ...
            <div class="details-title main-title">Ažuriraj odgovor</div>
            <div class="details-content">
                <g:hiddenField name="id" value="${answer?.id}" />
                <g:render template="form" model="[answerInstance: answer]"/>
            </div>
            <div class="details-footer">
                <div class="row">
                    <div class="col-md-offset-8 col-md-2 col-sm-12">
                        <g:link controller="answer" action="list" id="${answer.id}" class="btn btn-default">Odustani</g:link>
                    </div>
